...
**Workspace one-line copy pass — 2026-08-28:** At standard desktop width, the full Employee description, “Upload and track documents you own, with secure access to approved verification reports,” now remains on one line. The desktop workspace identity subtitle, “Document custody environment,” also remains on one line. Small-screen rules intentionally preserve normal wrapping instead of risking clipped text.
