...
export default function Home() {
  return <main className="sd-landing">
    ...
    <section className="sd-hero">
      ...
      <div className="sd-evidence-console" aria-label="Evidence workflow illustration"><div className="sd-console-topline"><span>Evidence ledger</span><span className="sd-console-state">Ready for your records</span></div><article className="sd-dossier"><div className="sd-dossier-head"><div><p>Secure document workflow</p><strong>Your records stay private</strong></div><span className="sd-seal"><ShieldCheck size={20} /></span></div><div className="sd-dossier-body"><div className="sd-proof-line"><span>Ownership</span><strong>Role-controlled access</strong></div><div className="sd-proof-line"><span>Review</span><strong className="approved">Manager decision trail</strong></div><div className="sd-proof-line"><span>Verification</span><strong>Generated after approval</strong></div><div className="sd-chain"><i /> Upload a document to begin your proof chain</div></div></article><div className="sd-console-foot"><span>No sample records shown</span><span>Awaiting your data</span></div></div>
    </section>
